...
contract Raffle is VRFConsumerBaseV2Plus {
    ...
    function enterRaffle() external payable {
        // require(msg.value >= i_entranceFee, "Send Enough Eth To Enter Raffle!")
        // require(msg.value >= i_entranceFee, Raffle__SendMoreToEnterRaffle());  for sol 0.8.26 and above.
    ...
    /**
     * @dev This is the function that the chainlink node will call to see if the raffle is ready to have a winner
     * Requires:
     * 1. Time interval has passed between raffle runs.
     * 2. The raffle is open.
     * 3. The contract has balance.
     * 4. Chainlink VRF subscription has LINK.
     * @param -ignored
